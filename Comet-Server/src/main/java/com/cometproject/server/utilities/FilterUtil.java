...
public class FilterUtil {
	...
	public static String process(String string) {
		...
		.replace(" ", "").replace("$", "s")
		.replace("µ", "u").replace("4", "a")
		.replace("0", "o").replace("3", "e")
		.replace("@", "a").replace("1", "i")
		.replace("é", "e").replace("$", "s")
		...
		.replace("ò", "o").replace("ü", "u")
		.replace("û", "u").replace("è", "e")
		.replace("ë", "e").replace("è", "e")
		.replace("ø", "o").replace("₱", "p")
		.replace("Ö", "o").replace("Ä", "a")
		.replace("Ë", "e").replace("Ã", "a")
		.replace("Õ", "o").replace("õ", "o")
		.replace("ì", "i").replace("`", "")
		.replace("Ù", "u").replace("Ü", "u")
		.replace("Û", "u").replace("Ð", "D")
		.replace("я", "r").replace("ω", "w")
		.replace("ð", "d").replace("Я", "r")
		.replace("Ω", "o").replace("¥", "")
		.replace("÷", "").replace("Ø", "o")
		.replace("ª", "").replace("†", "")
		.replace("º", "").replace("í", "i");
