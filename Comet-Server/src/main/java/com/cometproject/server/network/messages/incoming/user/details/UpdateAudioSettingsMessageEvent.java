...
public class UpdateAudioSettingsMessageEvent implements Event {
	...
	public void handle(Session client, MessageEvent msg) throws Exception {
		...
		if (client.getPlayer().getSettings().getVolumes().getSystemVolume() == systemVolume && client.getPlayer().getSettings().getVolumes().getFurniVolume() == furniVolume && client.getPlayer().getSettings().getVolumes().getTraxVolume() == traxVolume) {
			return;
		}
