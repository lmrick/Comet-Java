...
public class WaiterAI extends AbstractBotAI {
	...
	public static final Drink[] drinks = { new Drink("tea", 1), new Drink("juice", 2), new Drink("milk", 5), new Drink("coffee", 8), new Drink("decaff", 9), new Drink("espresso", 13), new Drink("mocha", 11), new Drink("iced_coffee", 15), new Drink("cappuccino", 16), new Drink("java", 17), new Drink("coke", 19), new Drink("cola", 19), new Drink("bubble", 24), new Drink("potion", 25), new Drink("pink_champagne", 35) };
