	...
	public void execute(Session client, String[] message) {
		if (message.length != 1) {
			...
			if (!message[0].equals(yes)) {
				...
				sendNotification(Locale.getOrDefault("command.flagme.bought", "You can change your username by clicking on yourself in a room and then click on 'Change your name'. You will be banned if your new name violates the rules!"), client);
			}
		}
	}
