...
public class MassMotdCommand extends ChatCommand {
	...
	public void execute(Session client, String[] message) {
		...
		this.logDesc = "El Staff <b>-s</b> ha mandado una alerta <i>MOTD</i> a todo el hotel. [<b>-c</b>]".replace("-s", client.getPlayer().getData().getUsername()).replace("-c", this.merge(message));
	}
