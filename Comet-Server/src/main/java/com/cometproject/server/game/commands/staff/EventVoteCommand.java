...
public class EventVoteCommand extends ChatCommand {
	...
	public void execute(Session client, String[] params) {
		...
		NetworkManager.getInstance().getSessions().broadcastWs(new RoomVoteMessage(client.getPlayer().getData().getUsername(), client.getPlayer().getData().getFigure(), new EventData[] { new EventData(roomIdA, roomDataA.getName(), roomDataA.getDescription()), new EventData(roomIdB, roomDataB.getName(), roomDataB.getDescription()) }, seconds));
