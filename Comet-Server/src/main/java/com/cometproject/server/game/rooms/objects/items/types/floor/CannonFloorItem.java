...
public class CannonFloorItem extends RoomItemFloor {
	...
	private final List<PlayerEntity> entitiesToKick = Lists.newArrayList();
	...
	public boolean onInteract(RoomEntity entity, int requestData, boolean isWiredTrigger) {
		...
		this.getRoom().getMapping().getTile(kickTile).getEntities().stream().filter(PlayerEntity.class::isInstance).forEachOrdered(kickableEntity -> {
	...
	public void onTickComplete() {
		this.entitiesToKick.forEach(PlayerEntity::kick);
