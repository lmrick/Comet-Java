...
public class GroupDataMessageComposer extends MessageComposer {
	...
	public void compose(IComposerDataWrapper msg) {
		...
		groups.forEach(group -> {
			...
			String colourA = this.groupItemService.getSymbolColours().get(group.getColourA()) != null ? this.groupItemService.getSymbolColours().get(group.getColourA()).getFirstValue() : "ffffff";
			String colourB = this.groupItemService.getBackgroundColours().get(group.getColourB()) != null ? this.groupItemService.getBackgroundColours().get(group.getColourB()).getFirstValue() : "ffffff";
